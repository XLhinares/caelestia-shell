...
ColumnLayout {
        ...
        property Process enabledCheckerProcess: Process {
            ...
            command: {
                ...
                if (cmd === undefined) return ["echo", "false"];  
                if (typeof cmd === 'boolean') return ["echo", cmd];  
        ...
        StyledRect {
            ...
            color: {
                ...
                return enabledBool ? Colours.palette.m3secondaryContainer : Colours.tPalette.m3surfaceContainer
                }
